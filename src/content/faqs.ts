...
export const TMS_FAQS: FaqItem[] = [
  ...
  },
  {
    ...
    a: "Most side effects are mild and self-limiting. The most common one would be headache and discomfort at the site of stimulation. Rarely, there is a <0.1% risk that seizure could occur. Notably, this is NOT higher than the lifetime prevalence of seizure in the general population.",
  },
  {
    q: "I am pregnant. Can I receive TMS?",
    a: "TMS is considered safe for mothers and the fetus. Treatment of depression during the pregnancy and post-partum period is important. With significant depressive symptoms in the mother, babies have more difficulties developing a secure attachment. A recently published long-term study demonstrated the safety of TMS in both children and mothers. After the mothers had received TMS, they and their children were followed for more than 20 years. None of the mothers or children experienced any detrimental effects from TMS.",
  },
  {
    q: "What factors affect the treatment outcome?",
    a: "Positive predictors of TMS outcome include: shorter duration of depression; recurrent depressive episode; taking a concomitant antidepressant; being less treatment resistant; presence of sleep disturbance. Negative outcome predictors include: older age; short duration of TMS therapy (<15 sessions); psychotic depression; history of poor response to electroconvulsive therapy (ECT).",
  },
  {
    q: "How likely will depression improve with TMS?",
    a: "In non treatment resistant depression, most patients show significant improvement and two thirds of them can see absence of depressive symptoms. In treatment-resistant depression, about one in three patients show significant improvement. Compared to patients without TMS, TMS is more than 5 times as likely to achieve a clearance of depressive symptoms: remission rate of treatment-resistant depression with TMS 30%, without TMS 6%.",
  },
  {
    q: "How good is the treatment effect in obsessive-compulsive disorder (OCD)?",
    a: "The data with TMS has been encouraging. About 40-60% of patients with OCD are resistant to at least one medication. With TMS, near half of patients with treatment resistant OCD can improve their symptoms significantly. TMS also improves depressive symptoms in addition to the obsessive-compulsive symptoms.",
  },
  {
    q: "Is the effect of TMS durable?",
    a: "Yes, the effect of TMS is durable. After the successful initial treatment, half of patients see sustained responses up to 1 year. Receiving a maintenance course of TMS can sustain the therapeutic effect of TMS. We also recommend patients to continue their oral antidepressants to maximize the durability of the treatment effect of TMS.",
  },
  {
    q: "Is a shorter but more intensive course of TMS available?",
    a: "Yes. The treatment course of TMS can be given several times a day over 5 days. The remission rate was near 80% for patients with depression in a controlled study conducted by Stanford University.",
  },
];
...
export const KETAMINE_FAQS: FaqItem[] = [
  ...
  },
  {
    ...
    a: "Using a twice-weekly dosing schedule, some patients would respond within a week. However, the effect tends to be short-lasting with fewer treatments. A 4-week treatment program is recommended.",
  },
  {
    q: "What factors affect the treatment outcome?",
    a: "Positive predictors of ketamine treatment outcome include: a shorter duration of depression; taking a concomitant antidepressant; being less treatment-resistant. Negative outcome predictors include: a higher number of treatment failures; more severe depressive illness.",
  },
  {
    q: "How is ketamine administered?",
    a: "While ketamine can be administered in multiple routes, our centre uses intramuscular and subcutaneous injections, as they have demonstrated effectiveness. During the induction phase, ketamine is administered twice weekly over 4 weeks.",
  },
  {
