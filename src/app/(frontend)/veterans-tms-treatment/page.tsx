...
// Verbatim excerpts surfaced from the clinic's current Google Business Profile.
const REVIEWS = [
        ...
        <section className="vtms-hero">
          ...
          <div className="vtms-wrap vtms-hero-grid">
            <div className="vtms-hero-copy">
              <p className="vtms-eyebrow">Care for Canadian Veterans</p><h1>TMS Treatment for Veterans</h1>
              ...
              <ul className="vtms-hero-points" aria-label="Treatment highlights"><li>Non-invasive</li><li>No anesthesia</li><li>Psychiatrist-led care</li></ul>
            ...
            <aside id="inquiry" className="vtms-hero-card" aria-label="Request information">
              <h2>Talk With Our Team</h2><p>Send us a message about TMS, VAC authorization or the next step in assessment.</p>
